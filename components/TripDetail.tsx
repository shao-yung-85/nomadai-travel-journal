...
import { getAttractionGuide } from '../services/gemini';
import { ChevronLeftIcon, MapIcon, WalletIcon, TicketIcon, PlaneIcon, TrashIcon, RobotIcon, ListIcon, PlusIcon, SpeakerWaveIcon, StopIcon, CalendarIcon, MapPinIcon, ClockIcon, PencilIcon } from './Icons';
...
type Tab = 'ITINERARY' | 'MAP' | 'BUDGET' | 'BOOKINGS';
